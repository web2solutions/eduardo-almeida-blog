...
[DHTMLX Blog](https://dhtmlx.com/blog/customer-spotlight-dhtmlx-cash-flow/)

2 - Perl bot created by me, that provides host automation over the shared hosting offered by Kinghost [Kinghost](www.kinghost.com.br). It fully automates the onboarding process of new clients:
...
[see in CPAN](https://metacpan.org/pod/WWW::Kinghost::Painel)
