...
-------------------------------------> Vetor Desordenado com 100 elementos diferentes
{
  comparacoes: 664,
  trocas: 68,
  tempo: '0.26751697063446045 milliseconds.'
}
-------------------------------------> Vetor Ordenado com 100 elementos diferentes
{
  comparacoes: 4950,
  trocas: 167,
  tempo: '1.314706027507782 milliseconds.'
}
-------------------------------------> Vetor Ordenado com 100 elementos iguais
{
  comparacoes: 4950,
  trocas: 266,
  tempo: '1.8642060160636902 milliseconds.'
}
-------------------------------------> Vetor Ordenado com 10 elementos diferentes
{
  comparacoes: 45,
  trocas: 275,
  tempo: '0.01898103952407837 milliseconds.'
}
-------------------------------------> Vetor Ordenado com 10 elementos iguais
{
  comparacoes: 45,
  trocas: 284,
  tempo: '0.021008968353271484 milliseconds.'
}
-------------------------------------> Vetor Desordenado com 10 elementos diferentes
{
  comparacoes: 37,
  trocas: 292,
  tempo: '0.013198018074035645 milliseconds.'
}
-------------------------------------> Vetor Desordenado com 10 elementos diferentes
{
  comparacoes: 22,
  trocas: 297,
  tempo: '0.010466992855072021 milliseconds.'
}
```
